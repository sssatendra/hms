...
MONGODB_URI=mongodb://user:pass@host:27017/emr?authSource=admin
REDIS_URL=redis://:password@host:6379

# JWT (CHANGE IN PRODUCTION!)
JWT_SECRET=minimum_32_chars_random_string
JWT_REFRESH_SECRET=another_minimum_32_chars_random_string
JWT_EXPIRES_IN=15m
JWT_REFRESH_EXPIRES_IN=7d

# Services
LAB_SERVICE_URL=http://backend-lab:8000
...
MINIO_BUCKET_LAB=hms-lab-files
MINIO_BUCKET_DICOM=hms-dicom-files
MINIO_SECURE=false  # true for production with TLS
JWT_SECRET=same_as_core_service
MAX_FILE_SIZE_MB=50
```
...
### Redis issues
```bash
docker-compose exec redis redis-cli -a hms_redis_pass ping
# Should return: PONG
```
...
The following features are architected but pending implementation:
...
- [ ] Advanced billing with insurance claim processing
- [ ] Appointment reminders (scheduled Bull job)
...
- [ ] Advanced analytics dashboard (charts, KPIs)
- [ ] Report PDF generation (lab results, prescriptions)
- [ ] Barcode/QR scanning for medication dispensing
- [ ] Bed management mobile view

### Long-term
- [ ] AI-assisted diagnosis suggestions
- [ ] Predictive inventory ordering
- [ ] ICD-10/CPT code autocomplete
